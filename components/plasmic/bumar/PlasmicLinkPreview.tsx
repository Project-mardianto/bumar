...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: i_OgCxFjvmDC/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__pcXsK)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__frrqW)}>
              <div className={classNames(projectcss.all, sty.freeBox___89WpV)}>
                <h5
