...
export type Riwayatsvg2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Riwayatsvg2Icon(props: Riwayatsvg2IconProps) {
  ...
  return (
    ...
    >
      ...
      <path
        d={"M14.837 17.314H8.346m3.764-3.579H8.345"}
        stroke={"currentColor"}
        strokeWidth={"1.2"}
        strokeLinecap={"round"}
      ></path>
...
export default Riwayatsvg2Icon;
/* prettier-ignore-end */
