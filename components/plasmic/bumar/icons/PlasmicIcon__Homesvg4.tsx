...
export type Homesvg4IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Homesvg4Icon(props: Homesvg4IconProps) {
  ...
  return (
    ...
    >
      ...
      <circle cx={"11.966"} cy={"9.175"} r={"2.3"} fill={"#474D5F"}></circle>
    </svg>
  );
}

export default Homesvg4Icon;
/* prettier-ignore-end */
